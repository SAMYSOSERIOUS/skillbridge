...
SOURCES: list[Source] = [
    ...
    Source(
        ...
        repo="openai/GPTs-are-GPTs",
        sha=SHA_GPTS,
        path="data/occupations_onet_basic_skills.csv",
        filename="occupations_onet_basic_skills.csv",
        min_rows=850,
        description="O*NET basic-skills importance+level per occupation (O*NET via MIT repo)",
    ),
    Source(
        key="onet_match",
        repo="openai/GPTs-are-GPTs",
        sha=SHA_GPTS,
        path="data/occupations_onet_bls_matched.csv",
        filename="occupations_onet_bls_matched.csv",
        min_rows=900,
        description="Occupation-name to SOC/OEWS matching table (crosswalk input)",
    ),
    Source(
        key="oews",
        repo="openai/GPTs-are-GPTs",
